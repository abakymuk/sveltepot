...
import { h as Me, m as Ue, u as Fe, o as Ye, s as ze } from '../chunks/3b2-FxGb.js';
...
function x(a, e, s = !1) {
	...
	const v = (b, f) => {
		...
		if (A) {
			const S = ae(o) === ne;
			!!r === S && ((o = se()), ie(o), M(!1), (l = !0));
		}
		var d = G(),
			_ = o;
		if (
			(d && ((c = document.createDocumentFragment()), c.append((_ = Z()))),
			r ? (n ??= f && p(() => f(_))) : (t ??= f && p(() => f(_))),
			d)
		) {
			var P = B,
				u = r ? n : t,
				g = r ? t : n;
			(u && P.skipped_effects.delete(u), g && P.skipped_effects.add(g), P.add_callback(h));
		} else h();
		l && M(!0);
	};
	(z(() => {
			...
			return (
				ue(() => {
					((n = t),
						(t = []),
						K(() => {
							a !== s(...t) && (e(a, ...t), n && U(s(...n), a) && e(null, ...n));
						}));
				}),
				() => {
					le(() => {
...
function N(a, e, s, o) {
	...
	if (t) {
		var h = W in a || Q in a;
		c = de(a, e)?.set ?? (h && e in a ? (u) => (a[e] = u) : void 0);
	}
	var v,
		b = !1;
	(t ? ([v, b] = Ve(() => a[e])) : (v = a[e]),
	...
	if (
		(n
			? (f = () => {
					var u = a[e];
					return u === void 0 ? y() : ((m = !0), u);
				})
			: (f = () => {
					var u = a[e];
					return (u !== void 0 && (i = void 0), u === void 0 ? i : u);
				}),
		n && (s & ve) === 0)
	)
		return f;
	if (c) {
		var l = a.$$legacy;
		return function (u, g) {
			return arguments.length > 0 ? ((!n || !g || l || b) && c(g ? f() : u), u) : f();
		};
	}
	var d = !1,
		_ = ((s & Ae) !== 0 ? me : he)(() => ((d = !1), f()));
	t && E(_);
	var P = be;
	return function (u, g) {
		if (arguments.length > 0) {
			const S = g ? E(_) : n && t ? ge(u) : u;
			return (I(_, S), (d = !0), i !== void 0 && (i = S), u);
		}
		return (ye && d) || (P.f & Ee) !== 0 ? _.v : E(_);
	};
}
function Ze(a) {
...
class Ge {
	...
	constructor(e) {
		...
		const n = new Proxy(
			...
			{
				get(t, r) {
					return E(s.get(r) ?? o(r, Reflect.get(t, r)));
				},
				has(t, r) {
					return r === Q ? !0 : (E(s.get(r) ?? o(r, Reflect.get(t, r))), Reflect.has(t, r));
				},
				set(t, r, i) {
					return (I(s.get(r) ?? o(r, i), i), Reflect.set(t, r, i));
				}
			}
		);
	...
	Ye(() => {
		const l = e.stores.page.subscribe(() => {
			E(t) &&
				(I(r, !0),
				De().then(() => {
					I(i, document.title || 'untitled page', !0);
				}));
		});
		return (I(t, !0), l);
	});
...
const it = Ze(Xe),
	ot = [
		() =>
			j(() => import('../nodes/0.Dnvx4nEz.js'), __vite__mapDeps([0, 1, 2, 3, 4]), import.meta.url),
		() =>
			j(
				() => import('../nodes/1.D-o02aaa.js'),
				__vite__mapDeps([5, 1, 6, 2, 7, 3, 8]),
				import.meta.url
			),
		() =>
			j(() => import('../nodes/2.C_3TNKIb.js'), __vite__mapDeps([9, 1, 6, 2, 10]), import.meta.url)
	],
	ct = [],
	ft = { '/': [2] },
	$e = {
	...
	et = Object.fromEntries(Object.entries($e.transport).map(([a, e]) => [a, e.decode])),
	ut = !1,
	lt = (a, e) => et[a](e);
export {
	lt as decode,
